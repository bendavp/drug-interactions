...
interaction_id_side_effect_id = dict(zip(drug_interaction_side_effects['Drug 1 ID'].str.cat(
    drug_interaction_side_effects['Drug 2 ID'].values), drug_interaction_side_effects['Side Effect ID']))
